...
import com.math.cleanarchex.infra.driven.blockchainProvider.dto.event.parameter.ArrayParameter;
import com.math.cleanarchex.infra.driven.blockchainProvider.dto.event.parameter.EventParameter;
import com.math.cleanarchex.infra.driven.blockchainProvider.dto.event.parameter.NumberParameter;
import com.math.cleanarchex.infra.driven.blockchainProvider.dto.event.parameter.StringParameter;
...
public class Web3jEventParameterConverter implements EventParameterConverter<Type> {
    ...
    private final Map<String, EventParameterConverter<Type>> typeConverters = new HashMap<String, EventParameterConverter<Type>>();
    ...
    private EventParameter<?> convertDynamicArray(DynamicArray<?> toConvert) {
        ...
        return new ArrayParameter(toConvert.getValue().getFirst().getTypeAsString().toLowerCase(),
