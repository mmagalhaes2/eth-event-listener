...
import com.math.cleanarchex.infra.driven.blockchainProvider.chain.config.factory.ContractEventDetailsFactoryFactoryBean;
import com.math.cleanarchex.infra.driven.blockchainProvider.chain.service.container.NodeServices;
import com.math.cleanarchex.infra.driven.blockchainProvider.chain.service.health.NodeHealthCheckService;
import com.math.cleanarchex.infra.driven.blockchainProvider.chain.service.health.WebSocketHealthCheckService;
import com.math.cleanarchex.infra.driven.blockchainProvider.chain.service.health.strategy.HttpReconnectionStrategy;
import com.math.cleanarchex.infra.driven.blockchainProvider.chain.service.health.strategy.WebSocketResubscribeNodeFailureListener;
import com.math.cleanarchex.infra.driven.blockchainProvider.chain.service.strategy.PollingBlockSubscriptionStrategy;
import com.math.cleanarchex.infra.driven.blockchainProvider.chain.service.strategy.PubSubBlockSubscriptionStrategy;
...
public class NodeBeanRegistrationStrategy {
    ...
    private String registerBlockchainServiceBean(Node node, Web3j web3j, BeanDefinitionRegistry registry) {
        ...
        final BeanDefinitionBuilder builder = BeanDefinitionBuilder.genericBeanDefinition(
                com.math.cleanarchex.infra.driven.blockchainProvider.chain.service.Web3jService.class);
